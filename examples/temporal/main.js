( function () {
    ...
    var main = function () {
        ...
        function prepCamerasForComposerFilterPingPong( composer ) {
            ...
            // SUPERSAMPLE
            // get camera, copy and add it to composer
            // so that we can switch between to render alternatively
            // in one texture and save it for future frame

            // get CameraRTTO so that we can switch camera later On
